class SCR_CustomResupplySelfSupportStationAction : SCR_BaseResupplySupportStationAction
{
	...
	void SetResupplyType(IEntity user, IEntity owner, SCR_ESupportStationResupplyType Type)
	{
		SCR_CustomResupplyCatalogItemSupportStationData Data = SCR_CustomResupplyCatalogItemSupportStationData.Cast(m_ResupplyData);
		if (Data)
		{
			Data.SetResupplyType(Type);
			Data.Init(owner);
			UpdateCanResupply(user, owner);
		}
	}
	//------------------------------------------------------------------------------------------------
