class ADM_ViewPaymentUI: ChimeraMenuBase
{
	...
	protected ButtonWidget m_okayButton;
	...
	override void OnMenuOpen() 
	{
        ...
        m_okayButton = ButtonWidget.Cast(m_wRoot.FindAnyWidget("Confirm"));
        m_cancelButton = ButtonWidget.Cast(m_wRoot.FindAnyWidget("Cancel"));
