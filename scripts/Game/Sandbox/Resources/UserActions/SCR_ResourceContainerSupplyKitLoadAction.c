class SCR_ResourceContainerSupplyKitLoadAction : SCR_ScriptedUserAction
{
	...
	override void PerformAction(IEntity pOwnerEntity, IEntity pUserEntity) 
 	{
		...
		||	!m_ResourceGenerator	&& !m_ResourceComponent.GetGenerator(EResourceGeneratorID.DEFAULT_STORAGE, m_eResourceType, m_ResourceGenerator)
		||	!m_ResourceConsumer		&& !m_ResourceComponent.GetConsumer(EResourceGeneratorID.DEFAULT_STORAGE, m_eResourceType, m_ResourceConsumer))
			return;
		...
		resourcePlayerControllerComponent.OnPlayerInteraction(EResourcePlayerInteractionType.STORAGE, m_ResourceConsumer.GetComponent(), m_ResourceGenerator.GetComponent(), m_eResourceType, m_fCurrentTransferValue);
	}
	...
	override event void Init(IEntity pOwnerEntity, GenericComponent pManagerComponent)
	{
		...
		m_ResourceGenerator	= m_ResourceComponent.GetGenerator(EResourceGeneratorID.DEFAULT_STORAGE, m_eResourceType);
		m_ResourceConsumer	= m_ResourceComponent.GetConsumer(EResourceGeneratorID.DEFAULT_STORAGE, m_eResourceType);
	}
}